...
import com.example.doan.viewmodel.factory.BaseCategoryViewModelFactory
...
@AndroidEntryPoint
class AirBladeFragment : BaseCategoryFragment() {
    @Inject
    lateinit var firestore: FirebaseFirestore

    val viewModel by viewModels<CategoryViewModel> {
        BaseCategoryViewModelFactory(firestore, Category.AirBlade)
    }
